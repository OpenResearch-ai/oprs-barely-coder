...
export const CATEGORIES: Category[] = [
  // ── 커뮤니티 ──
  { key: "vibe_coding", label: "바이브 코딩", color: "bg-purple-50 text-purple-700", group: "community", emoji: "✨" },
  { key: "ai",          label: "AI / LLM",   color: "bg-blue-50 text-blue-700",    group: "community", emoji: "🤖" },
  { key: "news",        label: "IT 뉴스",    color: "bg-orange-50 text-orange-700", group: "community", emoji: "📰" },
  { key: "showcase",    label: "쇼케이스",   color: "bg-green-50 text-green-700",  group: "community", emoji: "🚀" },
...
export const TYPE_BADGE: Record<string, { label: string; color: string; emoji?: string }> = {
  vibe_coding: { label: "바이브 코딩", color: "bg-purple-50 text-purple-700", emoji: "✨" },
  ai:          { label: "AI / LLM",   color: "bg-blue-50 text-blue-700",     emoji: "🤖" },
  news:        { label: "IT 뉴스",    color: "bg-orange-50 text-orange-700", emoji: "📰" },
  showcase:    { label: "쇼케이스",   color: "bg-green-50 text-green-700",   emoji: "🚀" },
