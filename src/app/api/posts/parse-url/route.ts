...
[마지막에 이 내용에 대한 의견/맥락 1~2문장 추가]

- summary 필드에 줄바꿈은 반드시 \\n 으로 표현 (JSON 이스케이프)
- 상세 항목은 최소 5개 이상, 각 항목마다 단순 사실이 아닌 의미/영향/수치 포함
- 절대 요약만 쓰지 말 것. TL;DR 이후 본문이 충실해야 함
...
Output JSON only (summary 필드에 \\n으로 줄바꿈 표현):
{
  ...
  "summary": "TL;DR: 핵심요약 문장1. 문장2. 문장3.\\n\\n- 상세항목1\\n- 상세항목2\\n- 상세항목3\\n- 상세항목4\\n- 상세항목5\\n\\n의견/맥락 한두 문장",
